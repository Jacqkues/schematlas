...
- The active frontend is Leptos 0.8 in ui/. Keep pure graph algorithms in the UI library and run layout in its worker binary. The former Svelte 5 frontend remains in src/ for comparison. Native dialog.showModal provides focus management.
