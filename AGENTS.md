...
- Agent conversations belong to the agent. Persist only its ACP session id on the project and resume with `session/load`; never copy transcript text into the workspace database.
